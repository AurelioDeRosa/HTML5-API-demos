...
- Battery Status API [[Specifications](http://www.w3.org/TR/battery-status/)] [[Article](http://code.tutsplus.com/tutorials/html5-battery-status-api--mobile-22795)] [[Live demo](http://aurelio.audero.it/demo/battery-status-api-demo.html)]
...
- Speech Synthesis API [[Specifications](https://dvcs.w3.org/hg/speech-api/raw-file/tip/speechapi.html#tts-section)] [[Live demo](http://aurelio.audero.it/demo/speech-synthesis-api-demo.html)]
